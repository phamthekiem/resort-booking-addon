...
class RBA_ACF_Bridge {
    ...
    public function register_room_fields(): void {
        acf_add_local_field_group( [
            'key'    => 'group_rba_room',
            'title'  => '🛏️ Thông Tin Phòng Nâng Cao (Resort)',
            'fields' => [
                // [
    ...
    public function register_tour_fields(): void {
        acf_add_local_field_group( [
            'key'    => 'group_rba_tour',
            'title'  => '🗺️ Thông Tin Tour Nội Khu',
            'fields' => [
                [
                    'key'     => 'field_tour_type',
                    'label'   => 'Loại tour',
                ...
                [
                    ...
                    'choices' => [
                        ...
                        'hard'   => '🔴 Cao — Phù hợp người năng động',
                    ],
                    'layout'  => 'horizontal',
                ],
                [
    ...
    public function register_resort_fields(): void {
        acf_add_local_field_group( [
            ...
            'title'  => '🏖️ Thông Tin Khu Nghỉ Dưỡng',
            'fields' => [
                // [
